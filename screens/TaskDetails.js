...
const TaskDetails = ({currentTask,refreshCurrentTask}) => {
    ...
    let tempTaskDescription = task.description;
    return (
        <ScrollView >
            <View style={styles.container}>
                ...
                <View style={styles.menuWrapper}>
                    ...
                    <TouchableRipple onPress={() => {}}>
                        <View style={styles.menuItem}>
                            ...
                            <Text style={styles.menuItemText}>{task.titre}</Text>
                        </View>
                    </TouchableRipple>
                    <TouchableRipple onPress={() => {setDescriptionModalVisible(true)}} >
                        <View style={styles.menuItem}>
                            <Icon name="description" color={GlobalStyles.colors.primary600} size={25}/>
                            <Text style={styles.menuItemText}>{task.description|| "click to add a description"}</Text>
                        </View>
                    </TouchableRipple>
                    <TouchableRipple onPress={() => {}} >
                        <View style={styles.menuItem}>
                            <Icon name='calendar-plus-o' type='font-awesome' color={GlobalStyles.colors.primary600} size={25}/>
                            <Text style={styles.menuItemText}> You created this task on  {task.debut}</Text>
                        </View>
                    </TouchableRipple>
                    <TouchableRipple onPress={() => {}} >
                        <View style={styles.menuItem}>
                            <UserAvatar id={task.responsable.id} nom={task.responsable.nom}/>
                            <View style={{flex:1, flexDirection:"row", alignItems:"center"}}>
                                <Text style={styles.menuItemText}> assigned to</Text>
                                <Text style={[styles.menuItemText,{fontSize:20}]}>{task.responsable.nom}</Text>
                            </View>
                        </View>
                    </TouchableRipple>
                ...
                <View style={styles.taskButtons}>
                    <Button style={{backgroundColor:"#ffda79" ,margin:5}}
                            disabled={(taskStatus !== 'ATTENTE_VALIDATION') || progress!==100}
